            ...
            if (input.name == "leeftijd") {
                ...
                if (input.value) {
                    // console.log("change SVG - leeftijd:", input.value);
                        ...
                        else if(input.value >= 15 && input.value < 25) {
                         
                       
                   }
                        else if(input.value >= 25 && input.value < 35) {
                       console.log("Jonger dan 35");}
                        else if(input.value >= 35 && input.value < 45) {
                       console.log("Jonger dan 45");}
                        else if(input.value >= 45 && input.value < 55) {
                       console.log("Jonger dan 55");}
                        else if(input.value >= 55 && input.value < 65) {
