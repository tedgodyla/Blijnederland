var Interaction = {
    ...
    initHandlers: function () {
        ...
        $("form.profileform input").on("keyup", function(event) {
            ...
            console.log(naamDone);
            console.log(leeftijdDone);
            ...
            if (profileform || qform) {
                ...
                if (faultMessage)
                {
                    ...
                    if (profileform) {
                        ...
                        $(".card-profile .info span.icon").addClass("icon-" + questionIcon[0]);
                        $(".card-profile .info h3").text(questionAnswer[1]);
                        $(".card-profile .info h4").text(questionAnswer[2]);
