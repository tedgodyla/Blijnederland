            ...
            if (profileform || qform) {
                ...
                if (faultMessage)
                {
                    ...
                    if (profileform) {
                        ...
                        Charts.overviewChart.changeGeslacht(questionAnswer[0]);
                        Charts.overviewChart.changeLeeftijd(questionAnswer[2]);

                        $("#input_leeftijdNl").val(questionAnswer[2]);
                        $("#text_leeftijdNl").text(questionAnswer[2]);
                        $("#slider_leeftijdNl").slider("option", "value", questionAnswer[2]);

                        $("#geslachtNl"+questionAnswer[0]).prop("checked", true)
