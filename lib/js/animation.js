...
var Animation = {
    ...
    showQuestions: function () {
        tl.main.set(".profile .profile-wrap > .right", {
            opacity: 1
        });
        ...
        tl.main.to(".profile .profile-wrap > .right", 4, {
            opacity: 1
        });
